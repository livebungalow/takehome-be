...
class ZillowData(models.Model):
    rent_estimate = models.FloatField(null=True, validators=PriceValidator)
    rent_estimate_last_updated = models.DateField(null=True)
    estimate_amount = models.FloatField(null=True, validators=PriceValidator)
...
class Home(models.Model):
    ...
    bathrooms = models.FloatField(null=True, validators=[MinValueValidator(0)])
    bedrooms = models.IntegerField(validators=[MinValueValidator(0)])
    home_size = models.FloatField(null=True, validators=[MinValueValidator(0)])
    property_size = models.FloatField(null=True, validators=[MinValueValidator(0)])
    home_type = models.CharField(max_length=50)
    last_sold_date = models.DateField(null=True)
    last_sold_price = models.FloatField(null=True, validators=PriceValidator)
    rent_price = models.FloatField(null=True, validators=PriceValidator)
    tax_value = models.FloatField()
    tax_year = models.IntegerField()
    year_built = models.IntegerField(null=True, validators=YearValidator)
